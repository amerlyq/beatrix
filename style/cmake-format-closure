...
#
#%SUMMARY: style for large CMake projects
#%DEPS:(cmake-format>=0.6.0): |dev/cmake-format-airy-git| or |aur/cmake-format|
#%
...
# Format command names consistently as 'lower' or 'upper' case DFL=canonical
command_case = 'lower'

# Format keywords consistently as 'lower' or 'upper' case DFL=unchanged
keyword_case = 'upper'
